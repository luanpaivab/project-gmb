exports.seed = function (knex, Promise) {
  ...
  let arr2 = [
    {
      dth_sistema: "2020-07-07 08:15:05",
      dt_ocorrencia: "2020-07-08",
      hr_ocorrencia: "07:00",
      tipo_ocorrencia: "Arrastão",
  ...
  const tipo = [
    ...
    "Pichação",
    "Briga Generalizada",
    "Depredação ao Patrimônio Privado",
    "Depredação ao Patrimônio Público",
    "Depredação à Obras de Arte",
  ];
  ...
  return knex("vandalismo").insert(arr2);
};
