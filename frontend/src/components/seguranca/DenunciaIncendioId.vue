<template>
  <div class="denuncia-incendio-id">
    <PageTitle
      icon="fa fa-folder"
    ...
    <b-container fluid="sm">
      <div class="titulo">
        <h2>Relatório de Denuncia de Incêndio</h2>
      </div>
      <hr />
      <b-row>
        <b-col md="3" sn="12">
      ...
      <b-row>
        <b-col md="3">
          <b-form-group label="Local do Incêndio:" label-for="local-incendio">
            <b-form-input
              class="text-gbel"
              id="local-incendio"
              type="text"
              v-model="denuncia.local_incendio"
              required
              :readonly="true"
            />
          </b-form-group>
        ...
        <b-col md="3">
          <b-form-group label="Gênero Vítima:" label-for="genero-vitima">
            <b-form-input
              class="text-gbel"
              id="genero-vitima"
              type="text"
              v-model="denuncia.classific_genero"
              required
              :readonly="true"
            />
          </b-form-group>
        ...
        <b-col md="3">
          <b-form-group label="Raça Vítima:" label-for="etnia-vitima">
            <b-form-input
              class="text-gbel"
              id="etnia-vitima"
              type="text"
...
export default {
  ...
  mounted() {
    const url = `${baseApiUrl153}/denunciaincendio/${this.$route.params.id}`;
    axios.get(url).then((res) => (this.denuncia = res.data));
  },
};
</script>

<style>
.denuncia-incendio-id {
  padding: 20px;
}
</style>
