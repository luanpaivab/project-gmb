<template>
  <div class="denuncia-incendio-id">
    ...
    <b-container fluid="sm">
      <div class="titulo">
        <h2>Relatório de Denuncia de Vandalismo</h2>
      </div>
      <hr />
      <b-row>
        <b-col md="3" sn="12">
      ...
      <b-row>
        <b-col md="3">
          <b-form-group label="Tipo de Ocorrência:" label-for="tipo-ocorrencia">
            <b-form-input
              class="text-gbel"
              id="tipo-ocorrencia"
              type="text"
              v-model="denuncia.tipo_ocorrencia"
              required
              :readonly="true"
            />
          </b-form-group>
        ...
        <b-col md="3">
          <b-form-group label="Gênero Suspeito:" label-for="genero-suspeito">
            <b-form-input
              class="text-gbel"
              id="genero-suspeito"
              type="text"
              v-model="denuncia.classif_genero"
              required
              :readonly="true"
            />
          </b-form-group>
...
export default {
  ...
  mounted() {
    const url = `${baseApiUrl153}/denunciavandalismo/${this.$route.params.id}`;
