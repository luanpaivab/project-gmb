<template>
  <div class="troca-horario-id">
    <div >
      <PageTitle
        icon="fa fa-file-o"
        text=" Troca de Horário - "
        :main="troca.id"
        sub=""
      />
  ...
  <!-- Se eu já tenho um erro relatado, então essa minha div aparece com a informção do erro que eu já relatei -->
      ...
      <div class="content" id="content-troca-horario">
        <hr />
        <div class="titulo">
          <h2>Processo Interno Para Troca de Horário</h2>
        </div>
        <hr />
        <b-row>
          <b-col md="3">
        ...
        <div class="titulo pt-4">
          <h2>Dados da Troca de Horário</h2>
        </div>
        <hr>
        ...
        <b-row class="pt-4">
          <b-col md="6">
            <div class="test">
              <p>Dia da Troca do Solitante:</p>
              <div class="campo">
                {{ troca.dia_datroca_horario }}
              </div>
            </div>
          </b-col>
          <b-col md="3">
        ...
        <div class="campo-assinatura">
          ...
          <!-- <div class="card-ass" v-if="img2">
            <img
              :src="`${url}/uploads/${img2.filename}`"
              alt="/"
              height="210"
              width="410"
            />
...
export default {
  ...
  methods: {
    CriaPDF() {
      var minhaTabela = document.getElementById("content-troca-horario")
        .innerHTML;
      var style = "<style>";
      style =
        style +
    ...
    loadTroca(){
      const url = `${baseApiUrl}/trocahorario/${this.$route.params.id}`;
    ...
    Atualizando() {
      ...
      axios
        .put(`${baseApiUrl}/trocahorario/${id}`, this.troca)
        .then(() => {
          this.loadTroca()
        })
        .catch((error) => {
