<template>
  <div class="troca-turno-id">
    <div>
      ...
      <div
        v-if="troca.state === 'ERROR' && erro_existe === true"
        class="alerta"
      >
        <b-alert show variant="danger">
          <h4 class="alert-heading">
      ...
      <div class="content" id="content-troca-turno">
        <hr />
        <div class="titulo">
          <h2>Processo Interno Para Troca de Turno</h2>
        </div>
        <hr />
        <b-row>
          <b-col md="3">
        ...
        <b-row class="pt-4">
          ...
          <b-col md="4">
            <div class="test">
              <p>Turno Solicitante:</p>
              <div class="campo">
                {{ troca.turno_solicitante }}
              </div>
            </div>
          </b-col>
          <b-col md="4">
    ...
    <b-col>
      ...
      <b-button
        ...
        variant="danger"
        v-on:click="
          (troca.state = 'ERROR'), (troca.id_administrativo = user.id)
        "
...
export default {
  ...
  methods: {
    CriaPDF() {
      var minhaTabela = document.getElementById("content-troca-turno")
        .innerHTML;
      var style = "<style>";
      style =
        style +
    ...
    loadTroca() {
      const url = `${baseApiUrl}/trocaturno/${this.$route.params.id}`;
    ...
    Atualizando() {
      ...
      axios
        .put(`${baseApiUrl}/trocaturno/${id}`, this.troca)
        .then(() => {
          this.loadTroca()
        })
        .catch((error) => {
