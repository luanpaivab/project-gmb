<template>
  <div class="relatorio-missao-id">
    <div>
      ...
      <div class="content" id="content-relatorio-missao">
        <hr />
        <div class="titulo">
          <h2>Identificação do Relatório de Missão</h2>
        </div>
        <hr />
        <b-row>
          <b-col md="3">
        ...
        <b-row>
          ...
          <b-col md="4">
            <div class="test">
              <p>Órgão Responsável:</p>
              <div class="campo">
                {{ relatorio.orgao_responsavel }}
              </div>
            </div>
          </b-col>
        </b-row>
        ...
        <hr />
        <div class="titulo">
          <h2>Partes Envolvidas na Missão</h2>
        </div>
        <hr />
        <b-row>
          <b-col md="7">
            <div class="test">
              <p>Comandante da Missão:</p>
              <div class="campo">
        ...
        <b-row>
          <b-col md="8">
            <div class="test">
              <p>Órgãos Participantes:</p>
              <div class="campo">
                {{ relatorio.orgaos_participantes }}
              </div>
            </div>
          </b-col>
        </b-row>
...
export default {
  ...
  methods: {
    CriaPDF() {
      var minhaTabela = document.getElementById("content-relatorio-missao")
        .innerHTML;
      var style = "<style>";
      style =
        style +
    ...
    loadRelatorio() {
      const url = `${baseApiUrl}/relatoriomissao/${this.$route.params.id}`;
    ...
    Atualizando() {
      ...
      axios
        .put(`${baseApiUrl}/relatoriomissao/${id}`, this.relatorio)
        .then(() => {
          this.loadRelatorio()
        })
        .catch((error) => {
